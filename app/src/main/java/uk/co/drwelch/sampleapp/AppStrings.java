...
public class AppStrings {
    ...
    public static final String NO_DATA = "Loading data";
    public static final String PERSONID = "uk.co.drwelch.sampleapp.PERSONID";
    public static final String NOT_LOADED = "No data loaded";
    public static final String NONE_SELECTED = "Select person";
